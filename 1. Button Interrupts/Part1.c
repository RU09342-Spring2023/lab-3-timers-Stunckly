...
__interrupt void Port_2(void)
{
    ...
    if ((P2IES & BIT3) == 0)       // @TODO Fill in this argument within the If statement to check if the interrupt was triggered off a rising edge.
    {
        LED_Color = 0;
        P2IES |= BIT3;
    ...
    else if ((P2IES & BIT3) == 8) // @TODO Fill in this argument within the If statement to check if the interrupt was triggered off a falling edge.
    {
        LED_Color = 1;
        P2IES &= ~BIT3;
        // @TODO Add code to change which edge the interrupt should be looking for next
